...
exit();
    ...
    $query1 = "UPDATE student_room1 SET room_no='$roomdata' ,Student_id='$roll', Fname='$fname', Lname='$lname', branch='$branch', year_of_study='$year'   WHERE value='$roomdata'";
    $data1 = mysqli_query($conn, $query1);
...
<body>
    ...
    <h2 class="updateform">room Allocation Form A</h2>
    ...
    <div class="totalframe">
        <form action="#" method="post" enctype="multipart/form-data">
            ...
            <span class="std"><?php  echo $roomError ?></span>
